...
enum GptPropmtsEnum: string
{
    ...
    case GET_SUMMARY_PROMPT = 'You are an expert at summarizing lecture transcriptions, including those with mathematical equations. Your goal is to generate a well-structured, Markdown-formatted summary that correctly renders math expressions using LaTeX via MathJax, ensuring proper formatting for GitHub and other Markdown-supported platforms.

        Instructions:
        1. Extract and summarize key topics concisely while maintaining clarity.
        2. Ensure proper Markdown formatting for optimal readability and rendering:
        ...
        - Correctly format math equations using single $$...$$ blocks without spaces before or after:
            - Inline math (kept inside a sentence): $$E = mc^2$$
        ...
        3. Include timestamps to help students navigate the lecture.
        4. Ensure the summary reads naturally, like a well-structured study guide.
        ...
        [
            {
                "start": "00:00:00,000",
                "end": "00:00:05,000",
                "text": "Welcome to todays lecture on logistic regression. Well discuss how the decision boundary is formed."
            },
            {
                "start": "00:00:06,000",
                "end": "00:00:12,000",
